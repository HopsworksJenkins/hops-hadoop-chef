...
attribute "hops/nn/https_port",
          :description => "The namenode secure http server port.",
          :type => 'string'
...
attribute "hops/dn/https_port",
          :description => "The datanode secure http server port.",
          :type => 'string'
