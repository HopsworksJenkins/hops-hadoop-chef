...
default['hops']['hdfs']['group']               = node['install']['user'].empty? ? "hdfs" : node['install']['user']
...
default['hops']['yarn']['group']               = node['install']['user'].empty? ? "yarn" : node['install']['user']
...
default['hops']['rm']['group']                 = node['install']['user'].empty? ? "rmyarn" : node['install']['user']
default['hops']['rm']['user-home']             = "/home/#{node['hops']['rm']['user']}"
default['hops']['mr']['user']                  = node['install']['user'].empty? ? "mapred" : node['install']['user']
default['hops']['mr']['group']                 = node['install']['user'].empty? ? "mapred" : node['install']['user']
